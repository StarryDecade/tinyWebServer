...
;
const char *error_400_form = "Your request has bad syntax or inherently impossible to staisfy.\n";
...
const char *doc_root = "/home/starrydecade/project/tinyWebServer/root";
...
void http_conn::init(int sockfd, const sockaddr_in &addr) {
    ...
    m_address = addr;
    // int reuse = 1;
    // setsockopt(m_sockfd, SOL_SOCKET, SO_REQUESTADDR, &reuse, sizeof(reuse));
...
bool http_conn::write() {
    ...
    while (1) {
        ...
        if (bytes_have_send >= m_iv[0].iov_len) {
            ...
            m_iv[0].iov_len = m_iv[0].iov_len - bytes_to_send;
        }
    ...
    switch (ret) {
        ...
        case FILE_REQUEST: {
            ...
            if (m_file_stat.st_size != 0) {
                ...
                const char *ok_string = "<html><body></body></thml>";
